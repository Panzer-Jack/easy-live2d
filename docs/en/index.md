...
features:
  ...
  - icon: 📦
    ...
    details: Easy integration with modern frontend frameworks like Vue and React
  - icon: 🎮
    title: Rich Features
    details: Full control over models, motions, expressions, events, and more to meet various interaction needs
  - icon: 🎯
    title: Flexible Configuration
    details: Supports custom loading and rendering processes to adapt to different scenarios
---